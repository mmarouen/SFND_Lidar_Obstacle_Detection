...
public:
    ...
    void clusterHelper(int indice, const std::vector< PointT, Eigen::aligned_allocator< PointT >> points, std::vector<int>& cluster, std::vector<bool>& processed, KdTree* tree, float distanceTol);
